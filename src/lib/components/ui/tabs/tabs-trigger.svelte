...
<Tabs.Trigger
	...
	class={cn(
		'rounded px-4 py-1.5',
		'not-disabled:hover:bg-secondary-900 not-disabled:hover:cursor-pointer',
		'not-disabled:data-[state=active]:text-primary not-disabled:data-[state=active]:bg-gray-700',
