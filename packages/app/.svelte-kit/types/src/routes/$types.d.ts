...
type LayoutRouteId = RouteId | "/(loaded)" | "/(loaded)/account" | "/(loaded)/admin" | "/(loaded)/admin/notifications" | "/(loaded)/current-game" | "/(loaded)/history" | "/(loaded)/history/[id]" | "/(loaded)/leaderboards" | "/(loaded)/leaderboards/profile/[profileId]" | "/(loaded)/replays" | "/(loaded)/replays/[replayId]" | "/(loaded)/settings" | "/(loaded)/shortcuts" | "/(loaded)/twitch" | "/(loading)/splashscreen" | "/(onboarding)/setup" | null
